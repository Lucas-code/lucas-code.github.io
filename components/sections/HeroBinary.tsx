		...
		<section id="hero" className="section h-screen relative">
			...
			<div className="w-full h-full relative flex items-center justify-center">
                <div className="fadeIn flex flex-col gap-10 items-center rounded-2xl border border-white/10 bg-black/35 p-20 backdrop-blur-sm shadow-2xl">
                    {/* <div className="flex flex-col text-8xl lg:text-9xl font-bold">
                        <span>Lucas</span>
                        <span>Pango</span>
                    </div> */}
			...
			{/* 3D MODEL */}
			{/* <div className="lg:w-5/10 h-6/10 lg:h-auto">
				<HeroModel />
			</div> */}
		</section>
	)
...
// const HeroBinaryClient = dynamic(() => Promise.resolve(HeroBinary), { ssr: false });

// export default HeroBinaryClient;