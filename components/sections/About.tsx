...
export default function About() {
	...
	return (
		<section id="about" className="section flex flex-col">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 flex-1 p-10">
				<div className="grid grid-cols-1 gap-4 flex-1 text-2xl">
					<div className="flex flex-col gap-4">
						<div className="text-5xl font-bold">
							<div className="w-fit p-3 border-6 border-[#3795cf] rounded-xl mb-3">
					...
					<div className="flex flex-col gap-4">
						<div className="text-5xl font-bold">
							...
							<h1>What do you specialise in?</h1>
						</div>
						<p>
				...
				<div>
					<div className="flex gap-10 w-fit justify-self-center mb-10">
						<img src="/assets/uon.jpg" alt="University of Nottingham" className="rounded-lg size-40" />
						<div className="flex flex-col justify-center">
							<h1 className="text-5xl font-bold">University of Nottingham</h1>
							<h2 className="text-3xl">🎓 BSc Computer Science w/ Year In Industry</h2>
							<h3 className="text-2xl">📅 September 2022 - July 2026</h3>
							<h2 className="text-2xl">👨‍🏫Final Grade: Second Class, Division One (2:1)</h2>
						</div>
					</div>
					<div>
						<div className="">
							<div className="flex justify-evenly gap-4 transition-all">
								{uniModules.map((modules, index) => (
									<div
										key={index}
										className={`cursor-pointer text-2xl transition-all delay-150 duration-300 hover:text-3xl hover:font-bold hover:-translate-y-2 ${selectedYear === index && "text-3xl font-bold underline underline-offset-4"}`}
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
							{uniModules[selectedYear].map((module, index) => (
								<div key={index} className="bg-input h-30 flex items-center px-5 text-3xl rounded-lg">
									{module}
								</div>
							))}
						</div>
